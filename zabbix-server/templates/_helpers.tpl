...
Generate the PSK
*/}}
{{- define "zabbix-server.psk" -}}
{{- $secretName := printf "%s-psk" (include "zabbix-server.fullname" .) -}}
{{- $secret := (lookup "v1" "Secret" .Release.Namespace $secretName) -}}
{{- if $secret -}}
{{/*
Reusing current PSK since secret exists
*/}}
data:
...
*/}}
data:
  psk.identity: "{{ printf "%s-%s" .Release.Name (upper (randAlphaNum 5)) | b64enc }}"
  psk.key: "{{ randNumeric 64 | b64enc }}"
{{- end -}}
{{- end -}}